...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Com.Syncfusion.Gauges.SfCircularGauge.LabelViewRenderer, Syncfusion.SfGauge.Android, Version=15.3451.0.29, Culture=neutral, PublicKeyToken=null", LabelViewRenderer.class, __md_methods);
	}


	public LabelViewRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == LabelViewRenderer.class)
			mono.android.TypeManager.Activate ("Com.Syncfusion.Gauges.SfCircularGauge.LabelViewRenderer, Syncfusion.SfGauge.Android, Version=15.3451.0.29, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065:Android.Util.IAttributeSet, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0, p1 });
	}


	public LabelViewRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == LabelViewRenderer.class)
